/* Filename: publish.cpp
 * 
 * This program takes no arguments, and sends the status of the connected push button
...
#define TOPIC      "mikestepanik/feeds/control.pushbutton"
#define AUTHMETHOD "mikestepanik"
#define AUTHTOKEN  "aio_ZJXr62sdRijdj4HMgB4UbZ9qi72N"
#define QOS        1
#define TIMEOUT    10000L
#define ADC_PATH   "/sys/bus/iio/devices/iio:device0/in_voltage"
#define ADC        0
#define pushbutton_GPIO_path "/sys/class/gpio/gpio46/"
...
string readGPIO(string filename){
	fstream fs;
	string path(pushbutton_GPIO_path);
...
int main(int argc, char* argv[]) {
	...
	string pushbutton_input=readGPIO("value");
	...
	sprintf(str_payload, "%f", stof(pushbutton_input));
